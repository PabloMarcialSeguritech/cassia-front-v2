...
const InfoCis = ({
      ...
      try {
        console.log(
          "http://" +
            ...
            ":" +
            server.port +
            "/api/v1/cassia/ci_elements/history/" +
            cisSelected.element_id
        );
        const response = await fetch(
          "http://" +
            server.ip +
  ...
  return (
    <>
      <div className="cont_info_cis">
        <div className="top_info_cis">
          <div className="row_info_cis">
            ...
            <div className="txt-info_cis">{cisSelected.folio}</div>
          </div>
          <div className="row_info_cis">
            <div className="title-info_cis">
              <div style={{ width: "50%", justifyContent: "start" }}>Host:</div>
            </div>
            <div className="txt-info_cis">{cisSelected.name}</div>
          </div>
          <div className="row_info_cis">
            <div className="title-info_cis">
              <div style={{ width: "50%", justifyContent: "start" }}>IP:</div>
            </div>
            <div className="txt-info_cis">{cisSelected.ip}</div>
          </div>
          {/* <div className='row_info_cis'>
            <div className='title-info_cis'>
                    <div style={{width:'50%',justifyContent:'start'}}>
          ...
          <div className="row_info_cis">
            <div className="cel_row_info_cis ">
              <div
                className="title-info_cis hiddenPDF"
                style={{ width: "50%" }}
              >
                CI´s que afecta:
              </div>
              <div className="txt-info_cis" style={{ width: "50%" }}>
                <div className="cont-img-field-acciones info-cis-action hiddenPDF">
                  <img
                    className="img-field-acciones"
                    src="/iconos/cis-afecta.png"
                    title="Afecta"
                    alt="Afecta"
                    name="Afecta"
                    ci_id={cisSelected.element_id}
                    onClick={openCisAfectaModal}
                    style={{ height: "100%" }}
                  />
                </div>
              </div>
            ...
            <div className="cel_row_info_cis ">
              ...
              <div className="txt-info_cis " style={{ width: "50%" }}>
                <div className="cont-img-field-acciones info-cis-action hiddenPDF">
                  <img
                    className="img-field-acciones"
                    src="/iconos/cis-docs.png"
                    title="Editar"
                    name="Editar"
                    alt="Editar"
                    ci_id={cisSelected.element_id}
                    onClick={openCisDocsModal}
                    style={{ height: "100%" }}
                  />
                </div>
              </div>
            ...
            <div className="cel_row_info_cis">
              ...
              <div
                className="txt-info_cis"
                style={{
                  width: "50%",
                  color: cisSelected.status.toLowerCase().includes("activo")
                    ? "green"
                    : "red",
                }}
              >
                ...
                <div className="cont-search hiddenPDF">
                  {dataCisConf.loading ? (
                    ...
                    <Search
                      ...
                      onSearch={onSearch}
                      dataObject={dataCisConf.data.data.history}
      ...
      >
        <ModalCreateCisConfig
          server={server}
          buscar_cis_history={buscar_cis_history}
          setEditActiveConfig={setEditActiveConfig}
          editActiveConfig={editActiveConfig}
          dataCisConfig={dataCisConfig}
          ci_id={cisSelected.element_id}
      ...
      >
        <ModalCisDocs
          server={server}
          cisSelected={cisSelected}
          closeCisDocsModal={closeCisDocsModal}
        ></ModalCisDocs>
      </Modal>
      <Modal
      ...
      >
        <ModalCisAfecta
          server={server}
          cisSelected={cisSelected}
          closeCisAfectaModal={closeCisAfectaModal}
        ></ModalCisAfecta>
      </Modal>
    </>
  );
