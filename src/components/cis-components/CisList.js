    ...
    <>
          ...
          dataList
            ...
            .map((elemento, indice) => (
              ...
              >
                ...
                <div
                  className="field-body-table-cis field-medium"
                  style={{
                    fontWeight: "bold",
                    color: elemento.status.toLowerCase().includes("activo")
                      ? "green"
                      : "red",
                  }}
                >
                ...
                <div className="field-body-table-cis field-larger">
                  <div className="cont-img-field-acciones">
                    <img
                      ...
                      alt="Afecta"
                      style={{ height: "85%" }}
                      ci_id={elemento.ci_id}
                      onClick={(e) => {
                        e.stopPropagation();
                        openCisAfectaModal(elemento);
                      }}
                    />
                  </div>
                  <div className="cont-img-field-acciones">
                  ...
                  <div className="cont-img-field-acciones">
                    <img
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        handledeleteUserClick(elemento);
                      }}
                    />
                  </div>
                </div>
      ...
      >
        <ModalDeleteCis
          ...
          setError={setError}
          cis={userSelected}
          closDeleteCisModal={closDeleteCisModal}
        ></ModalDeleteCis>
      </Modal>
