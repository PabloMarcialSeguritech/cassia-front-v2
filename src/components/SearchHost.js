    ...
    return(
        ...
        <div className='contSearchHost'>
                <div className="container-searchHost">
                    <input defaultChecked className="checkbox-searchHost" type="checkbox" onClick={closeFindHost}/> 
                    ...
                    <div className='container-searchHost-list'>
                <div className='compact-searchHost-list'>
                    {
                        ...
                        resultList.map((element, index) => (
                            <div className='row-searchHost-list' onClick={()=>handleSelected(element)}>
                                {element.ip}
                            </div>
                        ))
